import React from 'react'; import { Card, CardGroup } from 'react-bootstrap';


const SingleAgriculture = ({ agriculture }) => {
    const { img, name, time, location } = agriculture
...
export default SingleAgriculture;